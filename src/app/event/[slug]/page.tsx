    ...
    <main>
      <section className="relative flex items-center justify-center overflow-hidden py-14 md:py-20">
        <Image
          ...
          priority
        />
        <div className="z-1 relative flex flex-col gap-6 lg:flex-row lg:gap-x-16">
          <Image
            src={event.imageUrl}
            alt={event.name}
            width={300}
          ...
          <div className="flex flex-col">
            ...
            <p className="whitespace-nowrap text-xl text-white/75">
              Organized bu <span className="italic">{event.organizerName}</span>
            </p>

            <button className="state-effects mt-5 rounded-md border-2 border-white/10 bg-white/20 py-2 text-lg capitalize lg:mt-auto">
              Get Tickets
            </button>
          </div>
        </div>
